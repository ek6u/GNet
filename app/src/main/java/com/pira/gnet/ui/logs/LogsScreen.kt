...
@Composable
fun LogItem(log: com.pira.gnet.data.LogEntry) {
    ...
    Row(
        ...
        Text(
            ...
            color = when (log.level) {
                com.pira.gnet.data.LogLevel.ERROR -> MaterialTheme.colorScheme.error
                com.pira.gnet.data.LogLevel.WARNING -> MaterialTheme.colorScheme.primary
